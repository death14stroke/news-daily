...
import com.andruid.magic.texttospeech.api.TtsApi;
...
public class AudioNewsService extends MediaBrowserServiceCompat implements Player.EventListener,
        NewsRepository.NewsLoadedListener, TtsApi.AudioConversionListener, NotificationUtil.NotificationListener {
    private static final String MEDIA_SERVICE = AudioNewsService.class.getSimpleName();
    private static final int MEDIA_NOTI_ID = 1, NEWS_FETCH_DISTANCE = 3;
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        if(metadataCompat==null || category == null)
            return;
         NotificationUtil.buildNotification(this, icon, category,
                metadataCompat, mediaSessionCompat.getSessionToken(), this);
    }
    ...
    public void onPositionDiscontinuity(int reason) {
        if(reason==Player.DISCONTINUITY_REASON_SEEK_ADJUSTMENT ||
            ...
            NotificationUtil.buildNotification(this, android.R.drawable.ic_media_pause,
                    category, mediaMetadataCompat, mediaSessionCompat.getSessionToken(), this);
        }
    }
    ...
    public void onAudioCreated(File file) {
        String utteranceId = FileUtil.getUtteranceId(file.getName());
    ...
    @Override
    public void onNotificationBuilt(NotificationCompat.Builder builder) {
        NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        Objects.requireNonNull(nm).notify(MEDIA_NOTI_ID, builder.build());
    ...
    @Override
    public void onImageLoaded(NotificationCompat.Builder builder) {
        NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        Objects.requireNonNull(nm).notify(MEDIA_NOTI_ID, builder.build());
    }
    ...
    private final class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPlay() {
            ...
            registerReceiver(mNoisyReceiver, new IntentFilter(
